...
function WorkInfo() {
  ...
  const handleDeleteWorkInfo = async (infoId) => {
    try {
      const response = await axios.delete(`http://localhost:3000/api/workexperience/${infoId}`, {
        headers: {
          'Content-Type': 'application/json',
        },
        withCredentials: true,
  ...
  const handleSaveWorkInfo = async () => {
    try {
      ...
      const response = await axios.post("http://localhost:3000/api/workexperience", transformedData, {
        headers: {
          'Content-Type': 'application/json',
        },
        withCredentials: true,
  ...
  const handleSaveEdit = async () => {
    if (editedWorkInfo) {
      ...
      try {
        const response = await axios.put(`http://localhost:3000/api/workexperience/${editedWorkInfo.exp_id}`, transformedData, {
        headers: {
          'Content-Type': 'application/json',
        },
        withCredentials: true,
