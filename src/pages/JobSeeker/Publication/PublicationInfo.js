...
function PublicationInfo({isLoggedInUser}) {
  ...
  const handleDeletePublicationInfo = async (infoId) => {
    try {
      const response = await axios.delete(`/api/publication/${infoId}`, {
        headers: {
          'Content-Type': 'application/json',
        },
        withCredentials: true,
  ...
  const handleSavePublicationInfo = async () => {
    try {
      ...
      const response = await axios.post("/api/publication", transformedData, {
        headers: {
          'Content-Type': 'application/json',
        },
        withCredentials: true,
  ...
  const handleSaveEdit = async () => {
    if (editedPublicationInfo) {
      ...
      try {
        const response = await axios.put(`/api/publication/${editedPublicationInfo.publication_id}`, transformedData, {
        headers: {
          'Content-Type': 'application/json',
        },
        withCredentials: true,
