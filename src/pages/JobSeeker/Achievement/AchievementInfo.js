...
function AchievementInfo({isLoggedInUser}) {
  ...
  const handleDeleteAchievement = async (achievementId) => {
    try {
      const response = await axios.delete(`/api/achievement/${achievementId}`, {
        headers: {
          'Content-Type': 'application/json',
        },
        withCredentials: true,
  ...
  const handleSaveAchievement = async () => {
    try {
      ...
      const response = await axios.post("/api/achievement", transformedData, {
        headers: {
          'Content-Type': 'application/json',
        },
        withCredentials: true,
  ...
  const handleSaveEdit = async () => {
    if (editedAchievement) {
      ...
      try {
        const response = await axios.put(`/api/achievement/${editedAchievement.achievement_id}`, transformedData, {
        headers: {
          'Content-Type': 'application/json',
        },
        withCredentials: true,
